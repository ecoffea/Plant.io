...
const mockProducts: Product[] = [
  { id: '1', name: 'Tomate', quantity: '5 kg', status: 'Aguardando' },
  { id: '2', name: 'Alface', quantity: '10 unidades', status: 'Em transporte' },
];
...
export default function ConsumerScreen() {
  ...
  const handleAudioSubmit = () => {
    ...
    Alert.alert(
      'Gravacao de Audio',
      'Fale o produto que deseja solicitar...',
      [
        {
          text: 'Parar Gravacao',
          onPress: () => {
  ...
  const renderProduct = ({ item }: { item: Product }) => (
    <View style={styles.productCard}>
      ...
      <View style={[styles.statusBadge, item.status === 'Em transporte' && styles.statusActive]}>
        ...
        {activeTab === 'main' ? (
          <View style={styles.content}>
            ...
            <FlatList
              ...
              ListEmptyComponent={
                <Text style={styles.emptyText}>Nenhum produto solicitado</Text>
              }
            />
            <View style={styles.buttonContainer}>
              <BigButton title="Inserir pedido" onPress={handleAddProduct} />
            </View>
          </View>
        ) : (
          <View style={styles.content}>
            <View style={styles.sectionHeader}>
              ...
              <Text style={styles.legend}>
                <Text style={styles.trendDown}>↓ Baixou</Text>
                {'  '}
                <Text style={styles.trendUp}>↑ Subiu</Text>
              </Text>
            </View>
            <FlatList
              data={mockMarket}
        ...
        <Modal visible={showInputModal} transparent animationType="fade">
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              <Text style={styles.modalTitle}>Inserir Pedido</Text>
              
              <View style={styles.inputSection}>
                <Text style={styles.inputLabel}>Inserir pedido escrito</Text>
                <TextInput
                  style={styles.input}
                  value={newProduct}
                  onChangeText={setNewProduct}
                  placeholder="Ex: 5kg de tomate"
              ...
              >
                ...
                <Text style={styles.audioText}>
                  {isRecording ? 'Gravando...' : 'Inserir pedido em audio'}
                </Text>
              </Pressable>
